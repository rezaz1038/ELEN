...
namespace SoftIran.Web.Controllers
{
    ...
    public class OffishCategoryController : ControllerBase
    {
        ...
        #region upsert
        [HttpPost]
        [Route("api/offish/category/upsert")]
        ...
        #region delete
        [HttpDelete("api/offish/category/{request}")]
        ...
        [HttpGet]
        [Route("api/offish/category/list ")]
        ...
        #region get  single
        [HttpGet]
        [Route("api/offish/category/{request}")]
        public async Task<IActionResult> Single([FromQuery] string request)
        {
            try
            {
