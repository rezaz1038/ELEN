...
namespace SoftIran.Web.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        #region delete
        [HttpDelete("api/identiy/user/{request}")]
        ...
        #region get  single
        [HttpGet]
        [Route("api/identiy/user/{request}")]
        ...
        [HttpPost]
        [Route("api/identiy/user/resetpassword")]
        ...
        [HttpPost]
        [Route("api/identiy/user/changepassword")]
